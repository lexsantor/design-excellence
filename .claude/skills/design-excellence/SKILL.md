...
| T4 | `references/gesture-physics.md`, `references/stacks/*.md` | gesture-physics only if drag/gesture interaction is actually in scope; a stack file only if that stack is detected/declared — none ship by default (see below) |
